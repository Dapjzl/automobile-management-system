...
<aside id="leftsidebar" class="sidebar">
    ...
    <div class="menu">
        <ul class="list">
            ...
            <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-apps"></i><span>Cars</span></a>
                <ul class="ml-menu">
                    <li><a href="{{ route('CarBrand') }}">Add New Car Brand</a></li>
                    <li><a href="{{ route('CarModel') }}">Add New Car Model</a></li>
                    <li><a href="{{ route('ViewCarBrand') }}">View Car Brands</a></li>
                    <li><a href="{{ route('ViewCarModel') }}">View Car Models</a></li>                    
                </ul>
            </li>
...
<script>
    window.addEventListener('model-success', event => {
        Swal.fire({
        icon: 'success',
        title: 'success',
        ...
        timer: 2000
            ...
            window.location = '{{ route('CarModel') }}';
        });
    })
</script>

<script>
    window.addEventListener('brand-success', event => {
        Swal.fire({
        icon: 'success',
        title: 'success',
        ...
        timer: 2000
            ...
            window.location = '{{ route('CarBrand') }}';
        });
    })
</script>
