           ...
           <div class="row clearfix">
               <div class="col-lg-12 col-md-12 col-sm-12">
                   <div class="card">
                       ...
                       <div class="body">
                           <form  wire:submit.prevent="updateVehicle" enctype="multipart/form-data" method="POST">
                               @csrf
                               ...
                               <button class="btn btn-raised btn-primary waves-effect" type="submit">UPDATE VEHICLE</button>
                           </form>
                       </div>
                   </div>
               </div>
