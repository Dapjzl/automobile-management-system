    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6 col-sm-6">
          <div class="about_content row">
            <div class="col-md-5 col-sm-4 col-xs-4">
              <div class="about_img"> <img src="{{ asset('assets/images/aboutus5.jpg')}}" alt="image"> </div>
            </div>
        ...
        <div class="col-md-6 col-sm-6">
          <div class="about_content row">
            <div class="col-md-5 col-sm-4 col-xs-4">
              <div class="about_img"> <img src="{{ asset('assets/images/aboutus1.jpg')}}" alt="image"> </div>
            </div>
            <div class="col-md-7 col-sm-8 col-xs-8">
        ...
        <div class="col-md-6 col-sm-6">
          <div class="about_content row">
            <div class="col-md-5 col-sm-4 col-xs-4">
              <div class="about_img"> <img src="{{ asset('assets/images/aboutus2.jpg')}}" alt="image"> </div>
            </div>
            <div class="col-md-7 col-sm-8 col-xs-8">
        ...
        <div class="col-md-6 col-sm-6">
          <div class="about_content row">
            <div class="col-md-5 col-sm-4 col-xs-4">
              <div class="about_img"> <img src="{{ asset('assets/images/aboutus3.jpg')}}" alt="image"> </div>
            </div>
            <div class="col-md-7 col-sm-8 col-xs-8">
              <h3>Our <span>Mission</span></h3>
              <p>On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment.</p>
